...
import static io.github.lolens.showcaser.fabric.network.message.s2c.conditional.patchouli.PatchouliOpenScreenMessage.TargetType.BOOK;
import static io.github.lolens.showcaser.fabric.network.message.s2c.conditional.patchouli.PatchouliOpenScreenMessage.TargetType.ENTRY;

public class PatchouliHandlerImpl {
    private static final Identifier ID = Identifier.of(MOD_ID, "patchouli");

    public static void register() {
        FabricServerCommands.Conditional.Patchouli.register();
        FabricNetworking.Conditional.Patchouli.register();
